...
async function getAuthHeader(credential, credentialsStorage) {
...
async function getClientCertificate(credential, credentialsStorage, options) {
    const resolvedCredential = resolveCredential(credential, credentialsStorage);
    if (resolvedCredential) {
...
async function TLSCertificateFromCredential(certificate, options) {
    if (certificate) {
        const tlsConfig = {};
...
async function getTLSCertificate(credential, credentialsStorage, options) {
    const resolvedCredential = resolveCredential(credential, credentialsStorage);
    if (resolvedCredential) {
